...
void main()
{
	//vec3 ambient = ambient_return * texture(texture_image, tex_coords);
	//vec3 diffuse = diffuse_return * texture(texture_image, tex_coords);
	//vec3 specular = specular_return * texture(texture_image, tex_coords);
