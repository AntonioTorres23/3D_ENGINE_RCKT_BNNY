...
void main()
{
	...
	vec3 position_of_model_fragments = vec3(transformation_matrix * vec4(local_coordinates, 1.0));
	...
	vec3 normal_coordinates = normal_coordinates_transformation_matrix * raw_normal_coordinates;

	vec3 normalized_normal_coordiantes = normalize(raw_normal_coordinates);
