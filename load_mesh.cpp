...
MESH_OBJ::MESH_OBJ(std::vector<vData_Struct> arg_model_vData, std::vector<unsigned int> arg_model_iData, std::vector<tData_Struct> arg_model_tData)
{
